...
class SecurityService(DiagnosticService):
    ...
    def run(self) -> dict:
        ...
        has_root, root_msg = self._check_root_presence()
        selinux_status = self._check_selinux_status()
        ld_active, ld_msg = self._check_ld_preload()
        suid_msg = self._check_termux_suid_binaries()
    ...
    def _check_root_presence(self) -> tuple:
        """
    ...
    def _check_selinux_status(self) -> str:
        """
    ...
    def _check_ld_preload(self) -> tuple:
        """
    ...
    def _check_termux_suid_binaries(self) -> str:
        """
